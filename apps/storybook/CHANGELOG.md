...
- Updated dependencies
  ...
  - @graviola/edb-linked-data-renderer@6.0.4
  - @graviola/edb-graph-traversal@1.6.3
  - @graviola/graviola-app-config@0.1.5
  - @graviola/local-oxigraph-store-provider@6.0.4
  ...
  - @graviola/sparql-store-provider@6.0.4
  - @graviola/edb-state-hooks@1.7.4
  - @graviola/edb-table-components@2.0.2
  - @graviola/edb-table-renderer-sparql-select@0.1.5
  - @graviola/edb-basic-renderer@4.2.3
...
- Updated dependencies
  ...
  - @graviola/edb-linked-data-renderer@6.0.3
  - @graviola/edb-graph-traversal@1.6.2
  - @graviola/graviola-app-config@0.1.4
  - @graviola/semantic-json-form@1.6.3
  - @graviola/semantic-views@0.1.2
  - @graviola/sparql-schema@1.6.2
  - @graviola/edb-state-hooks@1.7.3
  - @graviola/edb-table-components@2.0.1
  ...
  - @graviola/local-oxigraph-store-provider@6.0.3
  - @graviola/sparql-store-provider@6.0.3
  - @graviola/edb-basic-components@1.5.3
  - @graviola/edb-debug-utils@1.4.3
  - @graviola/entity-finder@1.5.3
  - @graviola/edb-basic-renderer@4.2.2
...
- Updated dependencies [3fdd17b]
  ...
  - @graviola/edb-table-components@2.0.0
...
- Updated dependencies
  ...
  - @graviola/edb-basic-renderer@4.2.0
  - @graviola/edb-core-types@1.5.0
  - @graviola/edb-debug-utils@1.4.0
  ...
  - @graviola/edb-table-components@1.5.0
  - @graviola/edb-ui-utils@0.4.0
  - @graviola/entity-finder@1.5.0
  - @graviola/json-schema-utils@1.6.0
  - @graviola/local-oxigraph-store-provider@6.0.0
  - @graviola/semantic-json-form@1.6.0
  - @graviola/semantic-jsonform-types@1.4.8
  - @graviola/sparql-schema@1.6.0
  - @graviola/sparql-store-provider@6.0.0
  - @graviola/graviola-app-config@0.1.1
  - @graviola/edb-table-renderer-sparql-select@0.1.1
  - @graviola/edb-core-utils@1.5.7
  - @graviola/edb-table-renderer-jsonld@0.1.1
  - @graviola/edb-markdown-renderer@1.4.8

## 0.0.2

### Patch Changes

- Remove stories and workspace usage for experimental/specialized packages that were extracted to `graviola-experiments`.

  The moved packages include `ideas/charts`, `ideas/resizable-drawer`, `vis-timeline`, `kxp-components`, `kxp-utils`, `marc-to-rdf`, `authorities`, `wikidata-utils`, `map-libre-gl-renderer`, `color-picker-renderer`, and `edb-sparnatural`.
